#ifndef AD_SHADOWED_DEFERRED_PBR_LIGHTING_PASS_H
#define AD_SHADOWED_DEFERRED_PBR_LIGHTING_PASS_H
...
namespace ade{
    ...
    struct AdShadowedPBRLightSettings{
        ...
        glm::vec4 shadowParams{ 1.f / 2048.f, 0.0015f, 0.035f, 0.f };
    };

    class AdShadowedDeferredPBRLightingPass{
    public:
        AdShadowedDeferredPBRLightingPass(AdVKRenderPass *renderPass, uint32_t framesInFlight);
        ~AdShadowedDeferredPBRLightingPass();
    ...
    private:
        ...
        std::vector<std::array<VkImage, 5>> mSourceImages;
