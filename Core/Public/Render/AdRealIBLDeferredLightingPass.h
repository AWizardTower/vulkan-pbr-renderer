#ifndef AD_REAL_IBL_DEFERRED_LIGHTING_PASS_H
#define AD_REAL_IBL_DEFERRED_LIGHTING_PASS_H
...
namespace ade{
    ...
    class AdRealIBLDeferredLightingPass{
    public:
        AdRealIBLDeferredLightingPass(AdVKRenderPass *renderPass, uint32_t framesInFlight);
        ~AdRealIBLDeferredLightingPass();
    ...
    private:
        ...
        std::vector<std::array<VkImage, 8>> mSourceImages;
