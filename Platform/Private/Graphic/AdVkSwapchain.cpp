...
namespace ade{
    static VkCompositeAlphaFlagBitsKHR SelectCompositeAlpha(VkCompositeAlphaFlagsKHR supportedCompositeAlpha) {
        ...
        for(const auto &candidate: candidates){
            if(supportedCompositeAlpha & candidate){
                return candidate;
            }
        }
    ...
    bool AdVKSwapchain::ReCreate() {
        ...
        VkSwapchainCreateInfoKHR swapchainInfo = {
                ...
                .compositeAlpha = SelectCompositeAlpha(mSurfaceInfo.capabilities.supportedCompositeAlpha),
