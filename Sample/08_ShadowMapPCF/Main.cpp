...
#include "Render/AdShadowDebugCompositePass.h"
...
protected:
    ...
    void OnInit() override {
        ...
        mShadowRenderTarget->AddMaterialSystem<ade::AdShadowDepthMaterialSystem>(&mShadowSettings.lightViewProj);
        ...
        mGBufferRenderTarget->SetColorClearValue(3, { 0.f, 0.f, 0.f, 1.f });
        ...
        mLightingPass = std::make_shared<ade::AdShadowedDeferredPBRLightingPass>(mLightingRenderPass.get(), mRenderer->GetFramesInFlight());
        mDebugCompositePass = std::make_shared<ade::AdShadowDebugCompositePass>(mPresentRenderPass.get(), mRenderer->GetFramesInFlight());
...
private:
    ...
    static constexpr float AmbientIntensity = 0.035f;
    ...
    void UpdateLightMatrices() {
        ...
        mShadowSettings.lightViewProj = lightProj * lightView;
        mShadowSettings.lightDirection = glm::vec4(lightDirection, 0.f);
        mShadowSettings.shadowParams = glm::vec4(1.f / static_cast<float>(ShadowMapSize), ShadowDepthBias, AmbientIntensity, 0.f);

        mDebugSettings.lightViewProj = mShadowSettings.lightViewProj;
        mDebugSettings.shadowParams = glm::vec4(1.f / static_cast<float>(ShadowMapSize), ShadowDepthBias, 0.f, 0.f);
        mDebugSettings.debugParams = glm::vec4(static_cast<float>(mDebugViewMode), 0.f, 0.f, 0.f);
    }
    ...
    void BuildGraphPasses() {
        ...
        mGraph->AddPass("RG.DeferredPBRLighting", { mGBufferBaseColor, mGBufferNormal, mGBufferMaterial, mGBufferWorldPosition, mShadowDepth }, { mLightingColor },
            [this](ade::AdRenderGraphContext &context) {
        ...
        mGraph->AddPass("RG.ShadowDebugComposite", { mLightingColor, mGBufferBaseColor, mGBufferNormal, mGBufferMaterial, mGBufferWorldPosition, mShadowDepth }, {},
            [this](ade::AdRenderGraphContext &context) {
    ...
    void SetupDebugInput() {
        ...
        mObserver->OnEvent<ade::AdKeyPressEvent>([this](const ade::AdKeyPressEvent &event){
            ...
            switch (event.mKeyCode) {
                case ade::KEY_1:
                    mDebugViewMode = ade::AdShadowDebugViewMode::Lit;
                    LOG_I("Shadow debug view: Lit");
                    break;
                case ade::KEY_2:
                    mDebugViewMode = ade::AdShadowDebugViewMode::ShadowMap;
                    LOG_I("Shadow debug view: ShadowMap");
                    break;
                case ade::KEY_3:
                    mDebugViewMode = ade::AdShadowDebugViewMode::ShadowFactor;
                    LOG_I("Shadow debug view: ShadowFactor");
                    break;
                case ade::KEY_4:
                    mDebugViewMode = ade::AdShadowDebugViewMode::BaseColor;
                    LOG_I("Shadow debug view: BaseColor");
                    break;
                case ade::KEY_5:
                    mDebugViewMode = ade::AdShadowDebugViewMode::Normal;
                    LOG_I("Shadow debug view: Normal");
                    break;
                case ade::KEY_6:
                    mDebugViewMode = ade::AdShadowDebugViewMode::Roughness;
                    LOG_I("Shadow debug view: Roughness");
                    break;
                case ade::KEY_7:
                    mDebugViewMode = ade::AdShadowDebugViewMode::Metallic;
                    LOG_I("Shadow debug view: Metallic");
                    break;
                default:
                    break;
            }
    ...
    std::shared_ptr<ade::AdShadowedDeferredPBRLightingPass> mLightingPass;
    std::shared_ptr<ade::AdShadowDebugCompositePass> mDebugCompositePass;
    ade::AdShadowDebugViewMode mDebugViewMode = ade::AdShadowDebugViewMode::Lit;
    ade::AdShadowedPBRLightSettings mShadowSettings{};
    ade::AdShadowDebugSettings mDebugSettings{};
